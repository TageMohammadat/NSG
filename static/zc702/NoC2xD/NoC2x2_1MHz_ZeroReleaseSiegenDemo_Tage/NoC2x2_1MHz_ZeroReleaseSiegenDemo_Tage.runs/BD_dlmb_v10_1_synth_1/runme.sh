...
HD_PWD='/home/tage/DegreeProject/zc702/NoC2xD/NoC2x2_1MHz_ZeroReleaseSiegenDemo_Tage/NoC2x2_1MHz_ZeroReleaseSiegenDemo_Tage.runs/BD_dlmb_v10_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_dlmb_v10_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_dlmb_v10_1.tcl
