...
HD_PWD='/home/tage/DegreeProject/zc702/NoC2xD/NoC2x2_1MHz_ZeroReleaseSiegenDemo_Tage/NoC2x2_1MHz_ZeroReleaseSiegenDemo_Tage.runs/BD_lmb_bram_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_lmb_bram_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_lmb_bram_2.tcl
