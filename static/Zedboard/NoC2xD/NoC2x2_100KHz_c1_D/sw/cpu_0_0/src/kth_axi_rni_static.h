...
// buf  = flit_id_size
// msg_size = 0
#define NOC_SWITCH_SEND(base,priority,spid,dpid,buf,msg_size) KTH_RNI_mWriteReg(base,KTH_NOC_RNI_CTRL_OFFSET,(0x80000000+priority<<(10+SIZE_SEND_CHANNELS))+(spid<<(6+SIZE_SEND_CHANNELS))+(dpid<<(2+SIZE_SEND_CHANNELS))+(buf<<2)+msg_size)
#define NOC_RNI_SEND(base,priority,spid,dpid,buf,msg_size) KTH_RNI_mWriteReg(base,KTH_NOC_RNI_CTRL_OFFSET,(priority<<(10+SIZE_SEND_CHANNELS))+(spid<<(6+SIZE_SEND_CHANNELS))+(dpid<<(2+SIZE_SEND_CHANNELS))+(buf<<2)+msg_size)
