...
# ----------------------------------------------------------------------------
# Custom IO
#set_property PACKAGE_PIN T22 [get_ports {pins_0_0_tri_o[0]}]
set_property PACKAGE_PIN T22 [get_ports {LD0}];  # "LD0"
# Custom IO
#set_property PACKAGE_PIN T21 [get_ports {pins_1_0_tri_o[0]}]
set_property PACKAGE_PIN T21 [get_ports {LD1}];  # "LD1"
# Custom IO
#set_property PACKAGE_PIN U22 [get_ports {pins_2_0_tri_o[0]}]
set_property PACKAGE_PIN U22 [get_ports {LD2}];  # "LD2"
# Custom IO
#set_property PACKAGE_PIN U21 [get_ports {pins_3_0_tri_o[0]}]
#set_property PACKAGE_PIN U21 [get_ports {pins_3_2_tri_o}];  # "LD3"
