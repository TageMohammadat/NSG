...
expect -c 'spawn -noecho vivado -mode tcl; expect {%} {send [exec cat scripts/createHDF.tcl scripts/exit.tcl]}; interact'
rm -rfv vivado*
echo -e "If no error message is observed, HDF should have been created in project/sw and ../../OUTPUTS"
