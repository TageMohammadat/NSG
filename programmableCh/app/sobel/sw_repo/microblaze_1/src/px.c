...
void p1_init(void)
{
	...
	p1_out0->x[0]=0xFFF1; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p1_to_p0,p1_out0_priority,1);//send 0xFFF1 as signature from P1
...
void p1_main(void)
{
	...
	int led=1; p1_out0->x[0]=1; p1_out2->x[0]=2; p1_out3->x[0]=3;
		...
		//Sending stuff
		//p1_out0->x[0]+=1; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p1_to_p0,p1_out0_priority,p1_out0_msg_len);
		//p1_out2->x[0]+=2; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p1_to_p2,p1_out2_priority,p1_out2_msg_len);
		//p1_out3->x[0]+=3; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p1_to_p3,p1_out3_priority,p1_out3_msg_len);
...
// ----- sobel filter stub ends ------------------------------------------
		...
		//compute_GX(tokens_GetPixel, tokensWrite_GX);
