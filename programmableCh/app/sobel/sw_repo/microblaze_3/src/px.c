...
void p3_init(void)
{
	...
	p3_out0->x[0]=0xFFF3; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p3_to_p0,p3_out0_priority,1);//send 0xFFF3 as signature from P3
};

void p3_main(void)
{
	//some initial counter value
	int led=3; p3_out0->x[0]=1; p3_out1->x[0]=2; p3_out2->x[0]=3;
		...
		//Sending stuff
		//p3_out0->x[0]+=1; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p3_to_p0,p3_out0_priority,p3_out0_msg_len);
		//p3_out1->x[0]+=2; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p3_to_p1,p3_out1_priority,p3_out1_msg_len);
		//p3_out2->x[0]+=3; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p3_to_p2,p3_out2_priority,p3_out2_msg_len);
