...
void p2_init(void)
{
	...
	p2_out0->x[0]=0xFFF2; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p2_to_p0,p2_out0_priority,1);//send 0xFFF2 as signature from P2
};

void p2_main(void)
{
	//some initial counter value
	int led=2; p2_out0->x[0]=1; p2_out1->x[0]=2; p2_out3->x[0]=3;
		...
		//Sending stuff
		//p2_out0->x[0]+=1; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p2_to_p0,p2_out0_priority,p2_out0_msg_len);
		//p2_out1->x[0]+=2; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p2_to_p1,p2_out1_priority,p2_out1_msg_len);
		//p2_out3->x[0]+=3; NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p2_to_p3,p2_out3_priority,p2_out3_msg_len);
