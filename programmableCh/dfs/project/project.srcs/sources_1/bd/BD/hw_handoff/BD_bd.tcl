...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_clock_converter_mdm, and set properties
  set axi_clock_converter_mdm [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axi_clock_converter_mdm ]
  set_property -dict [ list \
CONFIG.ACLK_ASYNC {1} \
CONFIG.SYNCHRONIZATION_STAGES {8} \
 ] $axi_clock_converter_mdm

  # Create instance: axi_clock_converter_ni0, and set properties
  set axi_clock_converter_ni0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axi_clock_converter_ni0 ]
  set_property -dict [ list \
CONFIG.ACLK_ASYNC {1} \
CONFIG.SYNCHRONIZATION_STAGES {8} \
 ] $axi_clock_converter_ni0

  # Create instance: axi_clock_converter_ni1, and set properties
  set axi_clock_converter_ni1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axi_clock_converter_ni1 ]
  set_property -dict [ list \
CONFIG.ACLK_ASYNC {1} \
CONFIG.SYNCHRONIZATION_STAGES {8} \
 ] $axi_clock_converter_ni1

  # Create instance: axi_clock_converter_ni2, and set properties
  set axi_clock_converter_ni2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axi_clock_converter_ni2 ]
  set_property -dict [ list \
CONFIG.ACLK_ASYNC {1} \
CONFIG.SYNCHRONIZATION_STAGES {8} \
 ] $axi_clock_converter_ni2

  # Create instance: axi_clock_converter_ni3, and set properties
  set axi_clock_converter_ni3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axi_clock_converter_ni3 ]
  set_property -dict [ list \
CONFIG.ACLK_ASYNC {1} \
CONFIG.SYNCHRONIZATION_STAGES {8} \
 ] $axi_clock_converter_ni3
...
CONFIG.ENABLE_EXT_TRIGGERS {0} \
  ...
  # Create instance: axi_perf_mon_2, and set properties
  set axi_perf_mon_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_perf_mon:5.0 axi_perf_mon_2 ]
  set_property -dict [ list \
CONFIG.C_ENABLE_ADVANCED {1} \
CONFIG.C_ENABLE_EVENT_COUNT {1} \
CONFIG.C_ENABLE_PROFILE {0} \
...
CONFIG.ENABLE_EXT_TRIGGERS {0} \
  ...
  # Create instance: axi_perf_mon_3, and set properties
  set axi_perf_mon_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_perf_mon:5.0 axi_perf_mon_3 ]
  set_property -dict [ list \
CONFIG.C_ENABLE_ADVANCED {1} \
CONFIG.C_ENABLE_EVENT_COUNT {1} \
CONFIG.C_ENABLE_PROFILE {0} \
...
CONFIG.ENABLE_EXT_TRIGGERS {0} \
  ...
  # Create instance: axi_pwm_pause_1, and set properties
  set axi_pwm_pause_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 axi_pwm_pause_1 ]
  set_property -dict [ list \
CONFIG.mode_64bit {0} \
 ] $axi_pwm_pause_1

  # Create instance: axi_pwm_pause_2, and set properties
  set axi_pwm_pause_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 axi_pwm_pause_2 ]
  set_property -dict [ list \
CONFIG.mode_64bit {0} \
 ] $axi_pwm_pause_2

  # Create instance: axi_pwm_pause_3, and set properties
  set axi_pwm_pause_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 axi_pwm_pause_3 ]
  set_property -dict [ list \
CONFIG.mode_64bit {0} \
 ] $axi_pwm_pause_3
  ...
  # Create instance: kth_axi_Mesh_2D_Nostrum_2x2x1_0, and set properties
  set kth_axi_Mesh_2D_Nostrum_2x2x1_0 [ create_bd_cell -type ip -vlnv kth.se:tage:kth_axi_Mesh_2D_Nostrum_2x2x1:1.0 kth_axi_Mesh_2D_Nostrum_2x2x1_0 ]
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {SD 0#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#ENET Reset#GPIO#I2C Reset#GPIO#SD 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#CAN 0#CAN 0#UART 1#UART 1#I2C 0#I2C 0#Enet 0#Enet 0} \
CONFIG.PCW_MIO_TREE_SIGNALS {cd#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#reset#gpio[12]#reset#gpio[14]#wp#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#gpio[28]#gpio[29]#gpio[30]#gpio[31]#gpio[32]#gpio[33]#gpio[34]#gpio[35]#gpio[36]#gpio[37]#gpio[38]#gpio[39]#clk#cmd#data[0]#data[1]#data[2]#data[3]#rx#tx#tx#rx#scl#sda#mdc#mdio} \
...
CONFIG.NUM_MI {4} \
  ...
  # Create instance: rst_module, and set properties
  set rst_module [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_module ]
  set_property -dict [ list \
...
CONFIG.LOGO_FILE {data/sym_andgate.png} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_clock_converter_mdm_M_AXI [get_bd_intf_pins axi_clock_converter_mdm/M_AXI] [get_bd_intf_pins mdm/S_AXI]
  connect_bd_intf_net -intf_net axi_clock_converter_ni0_M_AXI [get_bd_intf_pins axi_clock_converter_ni0/M_AXI] [get_bd_intf_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_0]
  connect_bd_intf_net -intf_net axi_clock_converter_ni1_M_AXI [get_bd_intf_pins axi_clock_converter_ni1/M_AXI] [get_bd_intf_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_1]
  connect_bd_intf_net -intf_net axi_clock_converter_ni2_M_AXI [get_bd_intf_pins axi_clock_converter_ni2/M_AXI] [get_bd_intf_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_2]
  connect_bd_intf_net -intf_net axi_clock_converter_ni3_M_AXI [get_bd_intf_pins axi_clock_converter_ni3/M_AXI] [get_bd_intf_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_3]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_clock_converter_mdm/S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_1_axi_periph_M01_AXI [get_bd_intf_pins axi_pwm_pause_1/S_AXI] [get_bd_intf_pins microblaze_1_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_1_axi_periph_M03_AXI [get_bd_intf_pins axi_clock_converter_ni1/S_AXI] [get_bd_intf_pins microblaze_1_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_1_axi_periph_M04_AXI [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins microblaze_1_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_1_axi_periph_M05_AXI [get_bd_intf_pins axi_perf_mon_1/S_AXI] [get_bd_intf_pins microblaze_1_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_1_axi_periph_M06_AXI [get_bd_intf_pins axi_timer_1/S_AXI] [get_bd_intf_pins microblaze_1_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_1_debug [get_bd_intf_pins mdm/MBDEBUG_0] [get_bd_intf_pins microblaze_1/DEBUG]
  ...
  connect_bd_intf_net -intf_net microblaze_2_axi_periph_M01_AXI [get_bd_intf_pins axi_pwm_pause_2/S_AXI] [get_bd_intf_pins microblaze_2_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net microblaze_2_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_2/S_AXI] [get_bd_intf_pins microblaze_2_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net microblaze_2_axi_periph_M03_AXI [get_bd_intf_pins axi_clock_converter_ni2/S_AXI] [get_bd_intf_pins microblaze_2_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_2_axi_periph_M04_AXI [get_bd_intf_pins axi_interconnect_0/S02_AXI] [get_bd_intf_pins microblaze_2_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_2_axi_periph_M05_AXI [get_bd_intf_pins axi_perf_mon_2/S_AXI] [get_bd_intf_pins microblaze_2_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_2_axi_periph_M06_AXI [get_bd_intf_pins axi_timer_2/S_AXI] [get_bd_intf_pins microblaze_2_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_2_debug [get_bd_intf_pins mdm/MBDEBUG_1] [get_bd_intf_pins microblaze_2/DEBUG]
  ...
  connect_bd_intf_net -intf_net microblaze_3_axi_periph_M01_AXI [get_bd_intf_pins axi_pwm_pause_3/S_AXI] [get_bd_intf_pins microblaze_3_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net microblaze_3_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_3/S_AXI] [get_bd_intf_pins microblaze_3_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net microblaze_3_axi_periph_M03_AXI [get_bd_intf_pins axi_clock_converter_ni3/S_AXI] [get_bd_intf_pins microblaze_3_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_3_axi_periph_M04_AXI [get_bd_intf_pins axi_interconnect_0/S03_AXI] [get_bd_intf_pins microblaze_3_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_3_axi_periph_M05_AXI [get_bd_intf_pins axi_perf_mon_3/S_AXI] [get_bd_intf_pins microblaze_3_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_3_axi_periph_M06_AXI [get_bd_intf_pins axi_timer_3/S_AXI] [get_bd_intf_pins microblaze_3_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_3_debug [get_bd_intf_pins mdm/MBDEBUG_2] [get_bd_intf_pins microblaze_3/DEBUG]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_clock_converter_ni0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_protocol_converter_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_perf_mon_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  # Create port connections
  connect_bd_net -net GPIO_SW_S_1 [get_bd_ports GPIO_SW_S] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports PMOD1_0_LS] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_ports PMOD1_1_LS] [get_bd_pins axi_gpio_2/gpio_io_o]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_ports PMOD1_2_LS] [get_bd_pins axi_gpio_3/gpio_io_o]
  connect_bd_net -net axi_pwm_pause_1_interrupt [get_bd_pins axi_pwm_pause_1/interrupt] [get_bd_pins microblaze_1_xlconcat/In0]
  connect_bd_net -net axi_pwm_pause_1_pwm0 [get_bd_pins axi_pwm_pause_1/pwm0] [get_bd_pins microblaze_1/Pause]
  connect_bd_net -net axi_pwm_pause_2_interrupt [get_bd_pins axi_pwm_pause_2/interrupt] [get_bd_pins microblaze_2_xlconcat/In0]
  connect_bd_net -net axi_pwm_pause_2_pwm0 [get_bd_pins axi_pwm_pause_2/pwm0] [get_bd_pins microblaze_2/Pause]
  connect_bd_net -net axi_pwm_pause_3_interrupt [get_bd_pins axi_pwm_pause_3/interrupt] [get_bd_pins microblaze_3_xlconcat/In0]
  connect_bd_net -net axi_pwm_pause_3_pwm0 [get_bd_pins axi_pwm_pause_3/pwm0] [get_bd_pins microblaze_3/Pause]
  ...
  connect_bd_net -net axi_timer_3_interrupt [get_bd_pins axi_timer_3/interrupt] [get_bd_pins microblaze_3_xlconcat/In1]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm/Debug_SYS_Rst] [get_bd_pins rst_module/mb_debug_sys_rst]
  connect_bd_net -net microblaze_1_Pause_Ack [get_bd_ports PMOD1_3_LS] [get_bd_pins microblaze_1/Pause_Ack]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_clock_converter_mdm/m_axi_aclk] [get_bd_pins axi_clock_converter_mdm/s_axi_aclk] [get_bd_pins axi_clock_converter_ni0/m_axi_aclk] [get_bd_pins axi_clock_converter_ni0/s_axi_aclk] [get_bd_pins axi_clock_converter_ni1/m_axi_aclk] [get_bd_pins axi_clock_converter_ni1/s_axi_aclk] [get_bd_pins axi_clock_converter_ni2/m_axi_aclk] [get_bd_pins axi_clock_converter_ni2/s_axi_aclk] [get_bd_pins axi_clock_converter_ni3/m_axi_aclk] [get_bd_pins axi_clock_converter_ni3/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_perf_mon_0/core_aclk] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axi_perf_mon_1/core_aclk] [get_bd_pins axi_perf_mon_1/s_axi_aclk] [get_bd_pins axi_perf_mon_1/slot_0_axi_aclk] [get_bd_pins axi_perf_mon_2/core_aclk] [get_bd_pins axi_perf_mon_2/s_axi_aclk] [get_bd_pins axi_perf_mon_2/slot_0_axi_aclk] [get_bd_pins axi_perf_mon_3/core_aclk] [get_bd_pins axi_perf_mon_3/s_axi_aclk] [get_bd_pins axi_perf_mon_3/slot_0_axi_aclk] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins axi_pwm_pause_1/s_axi_aclk] [get_bd_pins axi_pwm_pause_2/s_axi_aclk] [get_bd_pins axi_pwm_pause_3/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins axi_timer_2/s_axi_aclk] [get_bd_pins axi_timer_3/s_axi_aclk] [get_bd_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_0_ACLK] [get_bd_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_1_ACLK] [get_bd_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_2_ACLK] [get_bd_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_3_ACLK] [get_bd_pins mdm/S_AXI_ACLK] [get_bd_pins microblaze_1/Clk] [get_bd_pins microblaze_1_axi_intc/processor_clk] [get_bd_pins microblaze_1_axi_intc/s_axi_aclk] [get_bd_pins microblaze_1_axi_periph/ACLK] [get_bd_pins microblaze_1_axi_periph/M00_ACLK] [get_bd_pins microblaze_1_axi_periph/M01_ACLK] [get_bd_pins microblaze_1_axi_periph/M02_ACLK] [get_bd_pins microblaze_1_axi_periph/M03_ACLK] [get_bd_pins microblaze_1_axi_periph/M04_ACLK] [get_bd_pins microblaze_1_axi_periph/M05_ACLK] [get_bd_pins microblaze_1_axi_periph/M06_ACLK] [get_bd_pins microblaze_1_axi_periph/S00_ACLK] [get_bd_pins microblaze_1_local_memory/LMB_Clk] [get_bd_pins microblaze_2/Clk] [get_bd_pins microblaze_2_axi_intc/processor_clk] [get_bd_pins microblaze_2_axi_intc/s_axi_aclk] [get_bd_pins microblaze_2_axi_periph/ACLK] [get_bd_pins microblaze_2_axi_periph/M00_ACLK] [get_bd_pins microblaze_2_axi_periph/M01_ACLK] [get_bd_pins microblaze_2_axi_periph/M02_ACLK] [get_bd_pins microblaze_2_axi_periph/M03_ACLK] [get_bd_pins microblaze_2_axi_periph/M04_ACLK] [get_bd_pins microblaze_2_axi_periph/M05_ACLK] [get_bd_pins microblaze_2_axi_periph/M06_ACLK] [get_bd_pins microblaze_2_axi_periph/S00_ACLK] [get_bd_pins microblaze_2_local_memory/LMB_Clk] [get_bd_pins microblaze_3/Clk] [get_bd_pins microblaze_3_axi_intc/processor_clk] [get_bd_pins microblaze_3_axi_intc/s_axi_aclk] [get_bd_pins microblaze_3_axi_periph/ACLK] [get_bd_pins microblaze_3_axi_periph/M00_ACLK] [get_bd_pins microblaze_3_axi_periph/M01_ACLK] [get_bd_pins microblaze_3_axi_periph/M02_ACLK] [get_bd_pins microblaze_3_axi_periph/M03_ACLK] [get_bd_pins microblaze_3_axi_periph/M04_ACLK] [get_bd_pins microblaze_3_axi_periph/M05_ACLK] [get_bd_pins microblaze_3_axi_periph/M06_ACLK] [get_bd_pins microblaze_3_axi_periph/S00_ACLK] [get_bd_pins microblaze_3_local_memory/LMB_Clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_module/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET1_N [get_bd_pins processing_system7_0/FCLK_RESET1_N] [get_bd_pins util_vector_logic_1/Op2]
  connect_bd_net -net rst_clk_wiz_0_100M_bus_struct_reset [get_bd_pins microblaze_1_local_memory/SYS_Rst] [get_bd_pins microblaze_2_local_memory/SYS_Rst] [get_bd_pins microblaze_3_local_memory/SYS_Rst] [get_bd_pins rst_module/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_0_100M_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins microblaze_1_axi_periph/ARESETN] [get_bd_pins microblaze_1_axi_periph/M02_ARESETN] [get_bd_pins microblaze_1_axi_periph/M03_ARESETN] [get_bd_pins microblaze_1_axi_periph/M04_ARESETN] [get_bd_pins microblaze_2_axi_periph/ARESETN] [get_bd_pins microblaze_2_axi_periph/M02_ARESETN] [get_bd_pins microblaze_2_axi_periph/M03_ARESETN] [get_bd_pins microblaze_2_axi_periph/M04_ARESETN] [get_bd_pins microblaze_3_axi_periph/ARESETN] [get_bd_pins microblaze_3_axi_periph/M02_ARESETN] [get_bd_pins microblaze_3_axi_periph/M03_ARESETN] [get_bd_pins microblaze_3_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins rst_module/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_0_100M_mb_reset [get_bd_pins microblaze_1/Reset] [get_bd_pins microblaze_1_axi_intc/processor_rst] [get_bd_pins microblaze_2/Reset] [get_bd_pins microblaze_2_axi_intc/processor_rst] [get_bd_pins microblaze_3/Reset] [get_bd_pins microblaze_3_axi_intc/processor_rst] [get_bd_pins rst_module/mb_reset]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_clock_converter_mdm/m_axi_aresetn] [get_bd_pins axi_clock_converter_mdm/s_axi_aresetn] [get_bd_pins axi_clock_converter_ni0/m_axi_aresetn] [get_bd_pins axi_clock_converter_ni0/s_axi_aresetn] [get_bd_pins axi_clock_converter_ni1/m_axi_aresetn] [get_bd_pins axi_clock_converter_ni1/s_axi_aresetn] [get_bd_pins axi_clock_converter_ni2/m_axi_aresetn] [get_bd_pins axi_clock_converter_ni2/s_axi_aresetn] [get_bd_pins axi_clock_converter_ni3/m_axi_aresetn] [get_bd_pins axi_clock_converter_ni3/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_perf_mon_0/s_axi_aresetn] [get_bd_pins axi_perf_mon_0/slot_0_axi_aresetn] [get_bd_pins axi_perf_mon_1/core_aresetn] [get_bd_pins axi_perf_mon_1/s_axi_aresetn] [get_bd_pins axi_perf_mon_1/slot_0_axi_aresetn] [get_bd_pins axi_perf_mon_2/core_aresetn] [get_bd_pins axi_perf_mon_2/s_axi_aresetn] [get_bd_pins axi_perf_mon_2/slot_0_axi_aresetn] [get_bd_pins axi_perf_mon_3/core_aresetn] [get_bd_pins axi_perf_mon_3/s_axi_aresetn] [get_bd_pins axi_perf_mon_3/slot_0_axi_aresetn] [get_bd_pins axi_pwm_pause_1/s_axi_aresetn] [get_bd_pins axi_pwm_pause_2/s_axi_aresetn] [get_bd_pins axi_pwm_pause_3/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins axi_timer_2/s_axi_aresetn] [get_bd_pins axi_timer_3/s_axi_aresetn] [get_bd_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_0_ARESETN] [get_bd_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_1_ARESETN] [get_bd_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_2_ARESETN] [get_bd_pins kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_3_ARESETN] [get_bd_pins mdm/S_AXI_ARESETN] [get_bd_pins microblaze_1_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_1_axi_periph/M00_ARESETN] [get_bd_pins microblaze_1_axi_periph/M01_ARESETN] [get_bd_pins microblaze_1_axi_periph/M05_ARESETN] [get_bd_pins microblaze_1_axi_periph/M06_ARESETN] [get_bd_pins microblaze_1_axi_periph/S00_ARESETN] [get_bd_pins microblaze_2_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_2_axi_periph/M00_ARESETN] [get_bd_pins microblaze_2_axi_periph/M01_ARESETN] [get_bd_pins microblaze_2_axi_periph/M05_ARESETN] [get_bd_pins microblaze_2_axi_periph/M06_ARESETN] [get_bd_pins microblaze_2_axi_periph/S00_ARESETN] [get_bd_pins microblaze_3_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_3_axi_periph/M00_ARESETN] [get_bd_pins microblaze_3_axi_periph/M01_ARESETN] [get_bd_pins microblaze_3_axi_periph/M05_ARESETN] [get_bd_pins microblaze_3_axi_periph/M06_ARESETN] [get_bd_pins microblaze_3_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_module/peripheral_aresetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins rst_module/ext_reset_in] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins rst_module/aux_reset_in] [get_bd_pins util_vector_logic_1/Res]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs axi_perf_mon_1/S_AXI/Reg] SEG_axi_perf_mon_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41C00000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs axi_pwm_pause_1/S_AXI/Reg] SEG_axi_pwm_pause_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41C10000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs axi_timer_1/S_AXI/Reg] SEG_axi_timer_1_Reg
  ...
  create_bd_addr_seg -range 0x00020000 -offset 0x70020000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_1/reg0] SEG_kth_axi_Mesh_2D_Nostrum_2x2x1_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x43400000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs mdm/S_AXI/Reg] SEG_mdm_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces microblaze_2/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_2/Data] [get_bd_addr_segs axi_perf_mon_2/S_AXI/Reg] SEG_axi_perf_mon_2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41C00000 [get_bd_addr_spaces microblaze_2/Data] [get_bd_addr_segs axi_pwm_pause_2/S_AXI/Reg] SEG_axi_pwm_pause_2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41C20000 [get_bd_addr_spaces microblaze_2/Data] [get_bd_addr_segs axi_timer_2/S_AXI/Reg] SEG_axi_timer_2_Reg
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces microblaze_2/Data] [get_bd_addr_segs microblaze_2_local_memory/dlmb_bram_if_cntlr/SLMB/Mem] SEG_dlmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces microblaze_2/Instruction] [get_bd_addr_segs microblaze_2_local_memory/ilmb_bram_if_cntlr/SLMB/Mem] SEG_ilmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x00020000 -offset 0x70020000 [get_bd_addr_spaces microblaze_2/Data] [get_bd_addr_segs kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_2/reg0] SEG_kth_axi_Mesh_2D_Nostrum_2x2x1_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x43400000 [get_bd_addr_spaces microblaze_2/Data] [get_bd_addr_segs mdm/S_AXI/Reg] SEG_mdm_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces microblaze_3/Data] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] SEG_axi_gpio_3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_3/Data] [get_bd_addr_segs axi_perf_mon_3/S_AXI/Reg] SEG_axi_perf_mon_3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41C00000 [get_bd_addr_spaces microblaze_3/Data] [get_bd_addr_segs axi_pwm_pause_3/S_AXI/Reg] SEG_axi_pwm_pause_3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41C30000 [get_bd_addr_spaces microblaze_3/Data] [get_bd_addr_segs axi_timer_3/S_AXI/Reg] SEG_axi_timer_3_Reg
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces microblaze_3/Data] [get_bd_addr_segs microblaze_3_local_memory/dlmb_bram_if_cntlr/SLMB/Mem] SEG_dlmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces microblaze_3/Instruction] [get_bd_addr_segs microblaze_3_local_memory/ilmb_bram_if_cntlr/SLMB/Mem] SEG_ilmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x00020000 -offset 0x70020000 [get_bd_addr_spaces microblaze_3/Data] [get_bd_addr_segs kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_3/reg0] SEG_kth_axi_Mesh_2D_Nostrum_2x2x1_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x43400000 [get_bd_addr_spaces microblaze_3/Data] [get_bd_addr_segs mdm/S_AXI/Reg] SEG_mdm_Reg
  ...
  create_bd_addr_seg -range 0x00020000 -offset 0x70020000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs kth_axi_Mesh_2D_Nostrum_2x2x1_0/S_AXI_0/reg0] SEG_kth_axi_Mesh_2D_Nostrum_2x2x1_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x43400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mdm/S_AXI/Reg] SEG_mdm_Reg
