...
HD_PWD='/home/tage/git/NoC/programmableCh/dfs/project/project.runs/BD_auto_pc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_auto_pc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_auto_pc_3.tcl
