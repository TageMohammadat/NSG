...
HD_PWD='/home/tage/git/NoC/programmableCh/dfs/project/project.runs/BD_kth_axi_Mesh_2D_Nostrum_2x2x1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_kth_axi_Mesh_2D_Nostrum_2x2x1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_kth_axi_Mesh_2D_Nostrum_2x2x1_0_0.tcl
