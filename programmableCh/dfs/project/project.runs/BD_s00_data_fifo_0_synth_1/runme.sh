...
HD_PWD='/home/tage/git/NoC/programmableCh/dfs/project/project.runs/BD_s00_data_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_s00_data_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_s00_data_fifo_0.tcl
