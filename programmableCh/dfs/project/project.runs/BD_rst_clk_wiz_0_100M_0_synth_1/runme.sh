...
HD_PWD='/home/tage/git/NoC/programmableCh/dfs/project/project.runs/BD_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_rst_clk_wiz_0_100M_0.tcl
