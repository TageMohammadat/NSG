...
HD_PWD='/home/tage/git/NoC/programmableCh/dfs/project/project.runs/BD_axi_pwm_pause_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_axi_pwm_pause_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_axi_pwm_pause_1_0.tcl
