...
HD_PWD='/home/tage/git/NoC/programmableCh/dfs/project/project.runs/BD_xbar_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_xbar_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_xbar_4.tcl
