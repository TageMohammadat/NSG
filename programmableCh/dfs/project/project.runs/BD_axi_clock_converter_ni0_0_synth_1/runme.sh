...
HD_PWD='/home/tage/git/NoC/programmableCh/dfs/project/project.runs/BD_axi_clock_converter_ni0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_axi_clock_converter_ni0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_axi_clock_converter_ni0_0.tcl
