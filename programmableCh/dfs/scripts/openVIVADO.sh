...
## *0* Launching tool
#################################################################################################################################################################################################################################################################################################################
pwd|xterm -e "cd $;source /opt/Xilinx/Vivado/2016.3/settings64.sh; expect -c 'spawn -noecho vivado -mode tcl; expect {%} {send [exec cat scripts/setenv.tcl scripts/openVIVADO.tcl]}; interact';" & disown;
