...
expect -c 'spawn -noecho vivado -mode tcl; expect {%} {send [exec cat scripts/setenv.tcl scripts/recreateBIT.tcl]}; interact'
rm -rfv vivado*
echo -e "If no error message is observed, ELFs should have been recreated in project/sw and ../../OUTPUTS"
