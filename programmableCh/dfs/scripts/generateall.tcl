...
# The Design
## PL: clocking wizard at 50 MHz, 3 Microblaze with AXI Timer, 64KB Local memory, GPIO with 3 LEDs [PMOD1_0_LS(DS19),PMOD1_1_LS(DS20),PMOD1_2_LS(DS21)]
...
## Create Microblaze with 64KB, and Interrupt Enable (Node 1)
create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:10.0 microblaze_1
apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config {local_mem "64KB" ecc "None" cache "None" debug_module "Debug Only" axi_periph "Enabled" axi_intc "1" clk "/clk_wiz_0/clk_out1" }  [get_bd_cells microblaze_1]
set_property -dict [list CONFIG.C_DEBUG_ENABLED {2}] [get_bd_cells microblaze_1]

## Create Microblaze with 64KB, and Interrupt Enable (Node 2)
create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:10.0 microblaze_2
apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config {local_mem "64KB" ecc "None" cache "None" debug_module "Debug Only" axi_periph "Enabled" axi_intc "1" clk "/clk_wiz_0/clk_out1" }  [get_bd_cells microblaze_2]
set_property -dict [list CONFIG.C_DEBUG_ENABLED {2}] [get_bd_cells microblaze_2]

## Create Microblaze with 64KB, and Interrupt Enable (Node 3)
create_bd_cell -type ip -vlnv xilinx.com:ip:microblaze:10.0 microblaze_3
apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config {local_mem "64KB" ecc "None" cache "None" debug_module "Debug Only" axi_periph "Enabled" axi_intc "1" clk "/clk_wiz_0/clk_out1" }  [get_bd_cells microblaze_3]
...
mkdir ../../OUTPUTS
cp BD_wrapper.bit KTH_Bitstream.bit
mv KTH_Bitstream.bit ../../OUTPUTS
cp BD_wrapper.hdf KTH_HDF.hdf
cp KTH_HDF.hdf ../../OUTPUTS
cp -r ../../sw_repo/A9_0  ../../OUTPUTS
cp ../../constraints.xdc ../../OUTPUTS
