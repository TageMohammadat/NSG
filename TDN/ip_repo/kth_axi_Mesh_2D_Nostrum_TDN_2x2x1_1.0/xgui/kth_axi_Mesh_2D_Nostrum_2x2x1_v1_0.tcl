...
proc update_MODELPARAM_VALUE.C_S02_AXI_BASEADDR { MODELPARAM_VALUE.C_S02_AXI_BASEADDR PARAM_VALUE.C_S02_AXI_BASEADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S02_AXI_BASEADDR}] ${MODELPARAM_VALUE.C_S02_AXI_BASEADDR}
}

proc update_MODELPARAM_VALUE.C_S02_AXI_HIGHADDR { MODELPARAM_VALUE.C_S02_AXI_HIGHADDR PARAM_VALUE.C_S02_AXI_HIGHADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S02_AXI_HIGHADDR}] ${MODELPARAM_VALUE.C_S02_AXI_HIGHADDR}
}

proc update_MODELPARAM_VALUE.C_S03_AXI_BASEADDR { MODELPARAM_VALUE.C_S03_AXI_BASEADDR PARAM_VALUE.C_S03_AXI_BASEADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S03_AXI_BASEADDR}] ${MODELPARAM_VALUE.C_S03_AXI_BASEADDR}
}

proc update_MODELPARAM_VALUE.C_S03_AXI_HIGHADDR { MODELPARAM_VALUE.C_S03_AXI_HIGHADDR PARAM_VALUE.C_S03_AXI_HIGHADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S03_AXI_HIGHADDR}] ${MODELPARAM_VALUE.C_S03_AXI_HIGHADDR}
}
