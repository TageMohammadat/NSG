...
// Channel recv/send_channel_p1_from/to_p0
extern volatile message *p1_in0,*p1_in0_heartbeat,*p1_out0;
extern int p1_out0_priority,p1_out0_msg_len;
// Channel recv/send_channel_p1_from/to_p1
extern volatile message *p1_in1,*p1_in1_heartbeat,*p1_out1;
extern int p1_out1_priority,p1_out1_msg_len;
// Channel recv/send_channel_p1_from/to_p2
extern volatile message *p1_in2,*p1_in2_heartbeat,*p1_out2;
extern int p1_out2_priority,p1_out2_msg_len;
// Channel recv/send_channel_p1_from/to_p3
extern volatile message *p1_in3,*p1_in3_heartbeat,*p1_out3;
extern int p1_out3_priority,p1_out3_msg_len;
