...
#define SMOC 0
#define COMB 1
#define recv_channel_p0_from_p3 0
#define recv_channel_p0_from_p2 1
#define recv_channel_p0_from_p1 2
#define recv_channel_p0_from_p0 3
#define send_channel_p0_to_p3 0
#define send_channel_p0_to_p2 1
#define send_channel_p0_to_p1 2
#define send_channel_p0_to_p0 3
// *****************************************************************************************************************************************
// *
...
#define PIO_0_BASE XPAR_PS7_GPIO_0_BASEADDR
...
// Channel recv/send_channel_p0_from/to_p0
extern volatile message *p0_in0,*p0_in0_heartbeat,*p0_out0;
extern int p0_out0_priority,p0_out0_msg_len;
// Channel recv/send_channel_p0_from/to_p1
extern volatile message *p0_in1,*p0_in1_heartbeat,*p0_out1;
extern int p0_out1_priority,p0_out1_msg_len;
// Channel recv/send_channel_p0_from/to_p2
extern volatile message *p0_in2,*p0_in2_heartbeat,*p0_out2;
extern int p0_out2_priority,p0_out2_msg_len;
// Channel recv/send_channel_p0_from/to_p3
extern volatile message *p0_in3,*p0_in3_heartbeat,*p0_out3;
extern int p0_out3_priority,p0_out3_msg_len;
