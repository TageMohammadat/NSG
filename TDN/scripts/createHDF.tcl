...
#### 3. IP for NoC: WORKDIR/ip_repo/kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_1.0
...
#### 5. Board is Zynq Evaluation Board and FPGA fabric are synthesized to work at 10MHz
...
# Change log
## Fixed: AXI to NoC interface timing issue Sept 17/8
## Created: March 17/16
## Changing HB period from 10 to 10 000 000 to make 1 second (later to 400Hz to correspond to 2 milli second of period)
## Changing the design to be non-secure (Later secure) /Feb 16
## tagem@kth.se
## Synopsis: Testing 2x2 NoC with 3 Microblaze systems connecting to the ARMexit
...
set_property  ip_repo_paths "[file normalize "$WORKDIR/ip_repo/kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_1.0"]" [current_project]
create_bd_design "BD"
add_files -fileset constrs_1 -norecurse $BOARDCONSTFIL
import_files -fileset constrs_1 $BOARDCONSTFIL
update_ip_catalog -rebuild
# Design parameters
set HEARTBEATTIMERCONST 10000000
...
set_property -dict [list CONFIG.G_TEMPLATE_LIST {1} CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_AREA_OPTIMIZED {1} CONFIG.G_USE_EXCEPTIONS {0} CONFIG.C_USE_MSR_INSTR {0} CONFIG.C_USE_PCMP_INSTR {0} CONFIG.C_USE_REORDER_INSTR {0} CONFIG.C_USE_BARREL {0} CONFIG.C_USE_DIV {0} CONFIG.C_USE_HW_MUL {0} CONFIG.C_USE_FPU {0} CONFIG.C_UNALIGNED_EXCEPTIONS {0} CONFIG.C_ILL_OPCODE_EXCEPTION {0} CONFIG.C_M_AXI_I_BUS_EXCEPTION {0} CONFIG.C_M_AXI_D_BUS_EXCEPTION {0} CONFIG.C_DIV_ZERO_EXCEPTION {0} CONFIG.C_FPU_EXCEPTION {0} CONFIG.C_NUMBER_OF_PC_BRK {0} CONFIG.C_USE_ICACHE {0} CONFIG.C_CACHE_BYTE_SIZE {4096} CONFIG.C_ICACHE_LINE_LEN {4} CONFIG.C_ICACHE_VICTIMS {0} CONFIG.C_ICACHE_STREAMS {0} CONFIG.C_USE_DCACHE {0} CONFIG.C_DCACHE_BYTE_SIZE {4096} CONFIG.C_DCACHE_LINE_LEN {4} CONFIG.C_DCACHE_USE_WRITEBACK {0} CONFIG.C_DCACHE_VICTIMS {0} CONFIG.C_MMU_DTLB_SIZE {2} CONFIG.C_MMU_ITLB_SIZE {1} CONFIG.C_USE_BRANCH_TARGET_CACHE {0}] [get_bd_cells microblaze_1]
### Optimize for performance
#apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config {local_mem "128KB" ecc "None" cache "None" debug_module "Debug Only" axi_periph "Enabled" axi_intc "1" clk "/clk_wiz_0/clk_out1" }  [get_bd_cells microblaze_1]
#set_property -dict [list CONFIG.C_DEBUG_ENABLED {2}] [get_bd_cells microblaze_1]
#set_property -dict [list CONFIG.C_ADDR_SIZE {36} CONFIG.G_TEMPLATE_LIST {2} CONFIG.G_USE_EXCEPTIONS {1} CONFIG.C_UNALIGNED_EXCEPTIONS {1} CONFIG.C_ILL_OPCODE_EXCEPTION {1} CONFIG.C_M_AXI_I_BUS_EXCEPTION {1} CONFIG.C_M_AXI_D_BUS_EXCEPTION {1} CONFIG.C_DIV_ZERO_EXCEPTION {1} CONFIG.C_FPU_EXCEPTION {1} CONFIG.C_DEBUG_ENABLED {2} CONFIG.C_AREA_OPTIMIZED {0} CONFIG.C_USE_MSR_INSTR {1} CONFIG.C_USE_PCMP_INSTR {1} CONFIG.C_USE_REORDER_INSTR {1} CONFIG.C_USE_BARREL {1} CONFIG.C_USE_DIV {1} CONFIG.C_USE_HW_MUL {2} CONFIG.C_USE_FPU {2} CONFIG.C_PVR {0} CONFIG.C_NUMBER_OF_PC_BRK {1} CONFIG.C_OPCODE_0x0_ILLEGAL {0} CONFIG.C_USE_ICACHE {1} CONFIG.C_CACHE_BYTE_SIZE {32768} CONFIG.C_ICACHE_LINE_LEN {8} CONFIG.C_ICACHE_VICTIMS {8} CONFIG.C_ICACHE_STREAMS {1} CONFIG.C_USE_DCACHE {1} CONFIG.C_DCACHE_BYTE_SIZE {32768} CONFIG.C_DCACHE_LINE_LEN {8} CONFIG.C_DCACHE_USE_WRITEBACK {1} CONFIG.C_DCACHE_VICTIMS {8} CONFIG.C_USE_MMU {0} CONFIG.C_MMU_DTLB_SIZE {4} CONFIG.C_MMU_ITLB_SIZE {2} CONFIG.C_USE_BRANCH_TARGET_CACHE {1}] [get_bd_cells microblaze_1]
#set_property -dict [list CONFIG.C_USE_ICACHE {0} CONFIG.C_USE_DCACHE {0}] [get_bd_cells microblaze_1]
#set_property -dict [list CONFIG.C_ADDR_SIZE {32} CONFIG.C_M_AXI_D_BUS_EXCEPTION {0} CONFIG.C_USE_STACK_PROTECTION {1} CONFIG.C_OPCODE_0x0_ILLEGAL {1}] [get_bd_cells microblaze_1]
...
set_property -dict [list CONFIG.G_TEMPLATE_LIST {1} CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_AREA_OPTIMIZED {1} CONFIG.G_USE_EXCEPTIONS {0} CONFIG.C_USE_MSR_INSTR {0} CONFIG.C_USE_PCMP_INSTR {0} CONFIG.C_USE_REORDER_INSTR {0} CONFIG.C_USE_BARREL {0} CONFIG.C_USE_DIV {0} CONFIG.C_USE_HW_MUL {0} CONFIG.C_USE_FPU {0} CONFIG.C_UNALIGNED_EXCEPTIONS {0} CONFIG.C_ILL_OPCODE_EXCEPTION {0} CONFIG.C_M_AXI_I_BUS_EXCEPTION {0} CONFIG.C_M_AXI_D_BUS_EXCEPTION {0} CONFIG.C_DIV_ZERO_EXCEPTION {0} CONFIG.C_FPU_EXCEPTION {0} CONFIG.C_NUMBER_OF_PC_BRK {0} CONFIG.C_USE_ICACHE {0} CONFIG.C_CACHE_BYTE_SIZE {4096} CONFIG.C_ICACHE_LINE_LEN {4} CONFIG.C_ICACHE_VICTIMS {0} CONFIG.C_ICACHE_STREAMS {0} CONFIG.C_USE_DCACHE {0} CONFIG.C_DCACHE_BYTE_SIZE {4096} CONFIG.C_DCACHE_LINE_LEN {4} CONFIG.C_DCACHE_USE_WRITEBACK {0} CONFIG.C_DCACHE_VICTIMS {0} CONFIG.C_MMU_DTLB_SIZE {2} CONFIG.C_MMU_ITLB_SIZE {1} CONFIG.C_USE_BRANCH_TARGET_CACHE {0}] [get_bd_cells microblaze_2]
### Optimize for performance
#apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config {local_mem "128KB" ecc "None" cache "None" debug_module "Debug Only" axi_periph "Enabled" axi_intc "1" clk "/clk_wiz_0/clk_out1" }  [get_bd_cells microblaze_2]
#set_property -dict [list CONFIG.C_DEBUG_ENABLED {2}] [get_bd_cells microblaze_2]
#set_property -dict [list CONFIG.C_ADDR_SIZE {36} CONFIG.G_TEMPLATE_LIST {2} CONFIG.G_USE_EXCEPTIONS {1} CONFIG.C_UNALIGNED_EXCEPTIONS {1} CONFIG.C_ILL_OPCODE_EXCEPTION {1} CONFIG.C_M_AXI_I_BUS_EXCEPTION {1} CONFIG.C_M_AXI_D_BUS_EXCEPTION {1} CONFIG.C_DIV_ZERO_EXCEPTION {1} CONFIG.C_FPU_EXCEPTION {1} CONFIG.C_DEBUG_ENABLED {2} CONFIG.C_AREA_OPTIMIZED {0} CONFIG.C_USE_MSR_INSTR {1} CONFIG.C_USE_PCMP_INSTR {1} CONFIG.C_USE_REORDER_INSTR {1} CONFIG.C_USE_BARREL {1} CONFIG.C_USE_DIV {1} CONFIG.C_USE_HW_MUL {2} CONFIG.C_USE_FPU {2} CONFIG.C_PVR {0} CONFIG.C_NUMBER_OF_PC_BRK {1} CONFIG.C_OPCODE_0x0_ILLEGAL {0} CONFIG.C_USE_ICACHE {1} CONFIG.C_CACHE_BYTE_SIZE {32768} CONFIG.C_ICACHE_LINE_LEN {8} CONFIG.C_ICACHE_VICTIMS {8} CONFIG.C_ICACHE_STREAMS {1} CONFIG.C_USE_DCACHE {1} CONFIG.C_DCACHE_BYTE_SIZE {32768} CONFIG.C_DCACHE_LINE_LEN {8} CONFIG.C_DCACHE_USE_WRITEBACK {1} CONFIG.C_DCACHE_VICTIMS {8} CONFIG.C_USE_MMU {0} CONFIG.C_MMU_DTLB_SIZE {4} CONFIG.C_MMU_ITLB_SIZE {2} CONFIG.C_USE_BRANCH_TARGET_CACHE {1}] [get_bd_cells microblaze_2]
#set_property -dict [list CONFIG.C_USE_ICACHE {0} CONFIG.C_USE_DCACHE {0}] [get_bd_cells microblaze_2]
#set_property -dict [list CONFIG.C_ADDR_SIZE {32} CONFIG.C_M_AXI_D_BUS_EXCEPTION {0} CONFIG.C_USE_STACK_PROTECTION {1} CONFIG.C_OPCODE_0x0_ILLEGAL {1}] [get_bd_cells microblaze_2]
...
set_property -dict [list CONFIG.G_TEMPLATE_LIST {1} CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_AREA_OPTIMIZED {1} CONFIG.G_USE_EXCEPTIONS {0} CONFIG.C_USE_MSR_INSTR {0} CONFIG.C_USE_PCMP_INSTR {0} CONFIG.C_USE_REORDER_INSTR {0} CONFIG.C_USE_BARREL {0} CONFIG.C_USE_DIV {0} CONFIG.C_USE_HW_MUL {0} CONFIG.C_USE_FPU {0} CONFIG.C_UNALIGNED_EXCEPTIONS {0} CONFIG.C_ILL_OPCODE_EXCEPTION {0} CONFIG.C_M_AXI_I_BUS_EXCEPTION {0} CONFIG.C_M_AXI_D_BUS_EXCEPTION {0} CONFIG.C_DIV_ZERO_EXCEPTION {0} CONFIG.C_FPU_EXCEPTION {0} CONFIG.C_NUMBER_OF_PC_BRK {0} CONFIG.C_USE_ICACHE {0} CONFIG.C_CACHE_BYTE_SIZE {4096} CONFIG.C_ICACHE_LINE_LEN {4} CONFIG.C_ICACHE_VICTIMS {0} CONFIG.C_ICACHE_STREAMS {0} CONFIG.C_USE_DCACHE {0} CONFIG.C_DCACHE_BYTE_SIZE {4096} CONFIG.C_DCACHE_LINE_LEN {4} CONFIG.C_DCACHE_USE_WRITEBACK {0} CONFIG.C_DCACHE_VICTIMS {0} CONFIG.C_MMU_DTLB_SIZE {2} CONFIG.C_MMU_ITLB_SIZE {1} CONFIG.C_USE_BRANCH_TARGET_CACHE {0}] [get_bd_cells microblaze_3]
### Optimize for performance
#apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config {local_mem "128KB" ecc "None" cache "None" debug_module "Debug Only" axi_periph "Enabled" axi_intc "1" clk "/clk_wiz_0/clk_out1" }  [get_bd_cells microblaze_3]
#set_property -dict [list CONFIG.C_DEBUG_ENABLED {2}] [get_bd_cells microblaze_3]
#set_property -dict [list CONFIG.C_ADDR_SIZE {36} CONFIG.G_TEMPLATE_LIST {2} CONFIG.G_USE_EXCEPTIONS {1} CONFIG.C_UNALIGNED_EXCEPTIONS {1} CONFIG.C_ILL_OPCODE_EXCEPTION {1} CONFIG.C_M_AXI_I_BUS_EXCEPTION {1} CONFIG.C_M_AXI_D_BUS_EXCEPTION {1} CONFIG.C_DIV_ZERO_EXCEPTION {1} CONFIG.C_FPU_EXCEPTION {1} CONFIG.C_DEBUG_ENABLED {2} CONFIG.C_AREA_OPTIMIZED {0} CONFIG.C_USE_MSR_INSTR {1} CONFIG.C_USE_PCMP_INSTR {1} CONFIG.C_USE_REORDER_INSTR {1} CONFIG.C_USE_BARREL {1} CONFIG.C_USE_DIV {1} CONFIG.C_USE_HW_MUL {2} CONFIG.C_USE_FPU {2} CONFIG.C_PVR {0} CONFIG.C_NUMBER_OF_PC_BRK {1} CONFIG.C_OPCODE_0x0_ILLEGAL {0} CONFIG.C_USE_ICACHE {1} CONFIG.C_CACHE_BYTE_SIZE {32768} CONFIG.C_ICACHE_LINE_LEN {8} CONFIG.C_ICACHE_VICTIMS {8} CONFIG.C_ICACHE_STREAMS {1} CONFIG.C_USE_DCACHE {1} CONFIG.C_DCACHE_BYTE_SIZE {32768} CONFIG.C_DCACHE_LINE_LEN {8} CONFIG.C_DCACHE_USE_WRITEBACK {1} CONFIG.C_DCACHE_VICTIMS {8} CONFIG.C_USE_MMU {0} CONFIG.C_MMU_DTLB_SIZE {4} CONFIG.C_MMU_ITLB_SIZE {2} CONFIG.C_USE_BRANCH_TARGET_CACHE {1}] [get_bd_cells microblaze_3]
#set_property -dict [list CONFIG.C_USE_ICACHE {0} CONFIG.C_USE_DCACHE {0}] [get_bd_cells microblaze_3]
#set_property -dict [list CONFIG.C_ADDR_SIZE {32} CONFIG.C_M_AXI_D_BUS_EXCEPTION {0} CONFIG.C_USE_STACK_PROTECTION {1} CONFIG.C_OPCODE_0x0_ILLEGAL {1}] [get_bd_cells microblaze_3]
...
### Low frequency
set_property -dict [list CONFIG.PCW_UIPARAM_DDR_FREQ_MHZ {333.333333} CONFIG.PCW_APU_PERIPHERAL_FREQMHZ {333.333333}] [get_bd_cells processing_system7_0]
### High frequency
#set_property -dict [list CONFIG.PCW_UIPARAM_DDR_FREQ_MHZ {533.333333} CONFIG.PCW_APU_PERIPHERAL_FREQMHZ {666.666666}] [get_bd_cells processing_system7_0]
...
## Create the network
### NI0 for A9_0 
create_bd_cell -type ip -vlnv kth.se:tage:kth_axi_Mesh_2D_Nostrum_TDN_2x2x1:1.0 kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0
...
connect_bd_net [get_bd_pins microblaze_1_xlconcat/In0] [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/NoC_Irq_1]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins microblaze_1_axi_periph/M03_AXI] [get_bd_intf_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_1]
...
connect_bd_net [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_1_ACLK] [get_bd_pins clk_wiz_0/clk_out1]
connect_bd_net [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_1_ARESETN] [get_bd_pins rst_module/peripheral_aresetn]
...
connect_bd_net [get_bd_pins microblaze_2_xlconcat/In0] [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/NoC_Irq_2]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins microblaze_2_axi_periph/M03_AXI] [get_bd_intf_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_2]
...
connect_bd_net [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_2_ACLK] [get_bd_pins clk_wiz_0/clk_out1]
connect_bd_net [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_2_ARESETN] [get_bd_pins rst_module/peripheral_aresetn]
...
connect_bd_net [get_bd_pins microblaze_3_xlconcat/In0] [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/NoC_Irq_3]
...
#### Connect Private NI NI2
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins microblaze_3_axi_periph/M03_AXI] [get_bd_intf_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_3]
...
connect_bd_net [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_3_ACLK] [get_bd_pins clk_wiz_0/clk_out1]
connect_bd_net [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_3_ARESETN] [get_bd_pins rst_module/peripheral_aresetn]
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/processing_system7_0/M_AXI_GP0" Clk "/clk_wiz_0/clk_out1" }  [get_bd_intf_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/S_AXI_0]
### Enable PS private interrupt to CPU 0 and connect it to NoC IRQ
set_property -dict [list CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_CORE0_FIQ_INTR {0} CONFIG.PCW_CORE0_IRQ_INTR {1} CONFIG.PCW_QSPI_GRP_SINGLE_SS_ENABLE {1}] [get_bd_cells processing_system7_0]
connect_bd_net [get_bd_pins processing_system7_0/Core0_nIRQ] [get_bd_pins kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0/NoC_Irq_0]
...
set_property offset 0x70020000 [get_bd_addr_segs {microblaze_1/Data/SEG_kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0_reg0}]
set_property offset 0x70020000 [get_bd_addr_segs {microblaze_2/Data/SEG_kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0_reg0}]
set_property offset 0x70020000 [get_bd_addr_segs {microblaze_3/Data/SEG_kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0_reg0}]
set_property offset 0x70020000 [get_bd_addr_segs {processing_system7_0/Data/SEG_kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0_reg0}]
...
assign_bd_address
set_property range 128K [get_bd_addr_segs {processing_system7_0/Data/SEG_kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0_reg0}]
set_property range 128K [get_bd_addr_segs {microblaze_1/Data/SEG_kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0_reg0}]
set_property range 128K [get_bd_addr_segs {microblaze_2/Data/SEG_kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0_reg0}]
set_property range 128K [get_bd_addr_segs {microblaze_3/Data/SEG_kth_axi_Mesh_2D_Nostrum_TDN_2x2x1_0_reg0}]
...
# Fix interrupt type
set_property -dict [list CONFIG.C_KIND_OF_EDGE.VALUE_SRC USER CONFIG.C_KIND_OF_LVL.VALUE_SRC USER CONFIG.C_KIND_OF_INTR.VALUE_SRC USER] [get_bd_cells microblaze_1_axi_intc]
set_property -dict [list CONFIG.C_KIND_OF_INTR {0xFFFFFFFF} CONFIG.C_IRQ_IS_LEVEL {0}] [get_bd_cells microblaze_1_axi_intc]
set_property -dict [list CONFIG.C_KIND_OF_EDGE.VALUE_SRC USER CONFIG.C_KIND_OF_LVL.VALUE_SRC USER CONFIG.C_KIND_OF_INTR.VALUE_SRC USER] [get_bd_cells microblaze_2_axi_intc]
set_property -dict [list CONFIG.C_KIND_OF_INTR {0xFFFFFFFF} CONFIG.C_IRQ_IS_LEVEL {0}] [get_bd_cells microblaze_2_axi_intc]
set_property -dict [list CONFIG.C_KIND_OF_EDGE.VALUE_SRC USER CONFIG.C_KIND_OF_LVL.VALUE_SRC USER CONFIG.C_KIND_OF_INTR.VALUE_SRC USER] [get_bd_cells microblaze_3_axi_intc]
set_property -dict [list CONFIG.C_KIND_OF_INTR {0xFFFFFFFF} CONFIG.C_IRQ_IS_LEVEL {0}] [get_bd_cells microblaze_3_axi_intc]
